namespace Templates.WebAPI.NH.VSIX
{
    #region << Using >>
    ...
    public sealed class Templates_WebAPI_NH_VSIX_Package : AsyncPackage
    {
        #region Constants

        /// <summary>
        ///     Templates.WebAPI.NH.VSIXPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "8d4c26c0-3067-4e4e-8de2-85d1f5fcefd5";
