namespace Templates.Blazor.NH.VSIX
{
    #region << Using >>
    ...
    public sealed class Templates_Blazor_NH_VSIX_Package : AsyncPackage
    {
        #region Constants

        /// <summary>
        ///     Templates.Blazor.NH.VSIXPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "47f07f25-0ce3-4fa2-9de8-d4477fdb0efc";
